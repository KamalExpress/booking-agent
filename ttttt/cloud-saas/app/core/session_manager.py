...
class SessionManager:
    ...
    def get_session(self, username: str, password: str, sitekey: str, captcha_api_key: str, force_refresh: bool = False) -> requests.Session:
        """
        ...
        with acc_lock:
            ...
            trust_svc = BrowserTrustService(captcha_api_key=captcha_api_key)
